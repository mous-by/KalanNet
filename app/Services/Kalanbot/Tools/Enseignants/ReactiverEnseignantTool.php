...
class ReactiverEnseignantTool extends AbstractKalanbotTool
{
    public function name(): string
    {
        return 'enseignants_reactiver';
    }
    ...
    {
        return "Réactiver le compte d'un enseignant précédemment archivé.";
    }
    ...
    public function confirmationMessage(array $args, User $user): string
    {
        ...
        return "Je vais réactiver {$nom}. Confirmez-vous ?";
    }
    ...
    public function execute(array $args, User $user): array
    {
        ...
        $outcome = $this->callController(fn () => app(EnseignantController::class)->reactivate((int) $validated['id_enseignant']));
        if (!$outcome['success']) {
            return $outcome;
        }
        ...
        return [
            'success' => true,
            'message' => 'Enseignant réactivé avec succès.',
            'data' => [],
        ];
    }
}
