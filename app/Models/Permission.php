...
class Permission extends Model
{
    ...
    public const CATALOG = [
        ...
        'communications' => [
            ...
            'permissions' => [
                'annonces_apercu' => 'Voir les annonces',
                'annonces_creation' => 'Créer une annonce',
        ...
        'pedagogie_enseignants' => [
            ...
            'permissions' => [
                ...
                'emargement_paiement_enseignant' => 'Payer les enseignants depuis les émargements',
                'presence_paiement_enseignant' => 'Payer les enseignants depuis le cahier de présence',
                'emargement_etat_de_payement' => 'Voir l’état de paiement des émargements',
                'presence_etat_de_payement' => 'Voir l’état de paiement des présences',
            ],
        ],
        'classes_cours' => [
            'label' => 'Classes & Cours',
            'permissions' => [
                ...
                'filieres_apercu' => 'Voir les filières (École de Santé)',
                'filieres_creation' => 'Créer une filière',
                'filieres_modification' => 'Modifier les filières',
                'filieres_supprimer' => 'Supprimer les filières',
        ...
        'evaluations' => [
            ...
            'permissions' => [
                ...
                'evaluation_validation_notes' => 'Valider les notes saisies',
                ...
                'bulletins_publication' => 'Publier les bulletins',
            ],
        ],
        'finances' => [
            'label' => 'Finances',
            'permissions' => [
                ...
                'subventions_etat_apercu' => 'Voir subventions État',
                'subventions_etat_encaisser' => 'Encaisser subvention État',
        ...
        'configuration' => [
            ...
            'permissions' => [
                ...
                'utilisateurs_creation' => 'Créer utilisateurs',
                'utilisateurs_modification' => 'Modifier utilisateurs',
                'utilisateurs_supprimer' => 'Supprimer un utilisateur',
                'permissions_apercu' => 'Voir permissions',
                'permission_voir' => 'Voir permissions',
    ...
    public static function canonicalName(?string $name): string
    {
        ...
        $directAliases = [
            ...
            'valider_note_saisi' => 'evaluation_validation_notes',
            'valider_notes_saisies' => 'evaluation_validation_notes',
            'validation_notes' => 'evaluation_validation_notes',
            'notes_validation' => 'evaluation_validation_notes',
            'publier_bulletins' => 'bulletins_publication',
            'publication_bulletins' => 'bulletins_publication',
            'annonces_publications' => 'annonces_apercu',
            'publications_apercu' => 'annonces_apercu',
            'publications_creation' => 'annonces_creation',
            'publications_supprimer' => 'annonces_supprimer',
            'utilisateur_supprimer' => 'utilisateurs_supprimer',
            'utilisateur_creation' => 'utilisateurs_creation',
            'utilisateur_création' => 'utilisateurs_creation',
            'utilisateur_modification' => 'utilisateurs_modification',
            'utilisateur_modifier' => 'utilisateurs_modification',
            'utilisateurs_modifier' => 'utilisateurs_modification',
            'utilisateurs_suppression' => 'utilisateurs_supprimer',
            'permission_voir' => 'permissions_apercu',
            'permission_apercu' => 'permissions_apercu',
            'permission_assigner' => 'permissions_assigner',
            'permissions_assignment' => 'permissions_assigner',
            'emargement_suppresion' => 'emargement_supprimer',
            'emargement_suppression' => 'emargement_supprimer',
            'valider_emargement' => 'emargement_validation_admin',
            'valider_émargement' => 'emargement_validation_admin',
            'emargement_validation' => 'emargement_validation_admin',
            'presence_création' => 'presence_creation',
            'presence_suppression' => 'presence_supprimer',
            'emargement_paiement_enseignant' => 'emargement_paiement_enseignant',
            'emargement_paiement enseignant' => 'emargement_paiement_enseignant',
            'presence_paiement_enseignant' => 'presence_paiement_enseignant',
            'presence_paiement enseignant' => 'presence_paiement_enseignant',
            'emargement_etat_de_payement' => 'emargement_etat_de_payement',
            'emargement_etat de payement' => 'emargement_etat_de_payement',
            'presence_etat_de_payement' => 'presence_etat_de_payement',
            'presence_etat de payement' => 'presence_etat_de_payement',
