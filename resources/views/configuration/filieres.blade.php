        ...
        <div class="col-12 col-lg-9">
            ...
            <div class="card theme-card shadow-sm">
                <div class="card-header theme-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <h5 class="mb-0 fw-bold"><i class="bi bi-diagram-3-fill me-2"></i>Filières</h5>
                ...
                <div class="card-body">
                    <div class="alert alert-info border-0 border-start border-info border-4">
                        Les filières (Infirmier, Sage-femme...) structurent les classes d'une <strong>École de Santé</strong>,
                        à la place de l'ordre d'enseignement Fondamentale/Secondaire utilisé par les autres écoles.
                    </div>
                                            ...
                                            @if($canEditFiliere || $canDeleteFiliere)
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 rounded-3">
                                                        ...
                                                        @if($canDeleteFiliere)
                                                            <li>
                                                                <form action="{{ route('configuration.filieres.destroy', $filiere->id_filiere) }}" method="POST" onsubmit="return confirm('Supprimer cette filière ?');">
                                                                    @csrf
                                                                    @method('DELETE')
